...
//                     {/* Featured Image */}
//                     <div className="mb-8">
//                         <div className="w-full h-96 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-lg flex items-center justify-center">
